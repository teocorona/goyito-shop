  ...
  return (
    <>
      <Grid container sx={{ mb: 1 }}>
        ...
        <Grid item xs={6}><Typography>3 artículos</Typography></Grid>

        <Grid item xs={6}><Typography>Subtotal</Typography></Grid>
        <Grid item xs={6}><Typography>$100</Typography></Grid>

        <Grid item xs={6}><Typography>Impuestos (16%)</Typography></Grid>
        <Grid item xs={6}><Typography>$16</Typography></Grid>

        <Grid item xs={6} sx={{ mt: 3 }}>
          <Typography variant="subtitle1">Total</Typography>
        </Grid>
        <Grid item xs={6} sx={{ mt: 3 }}>
          <Typography variant="subtitle1">$116</Typography>
        </Grid>
      </Grid>
    </>
  );
